...
import "./EnquireHotelDashboard.css";
import SearchIcon from "@mui/icons-material/Search";
import FileDownloadIcon from "@mui/icons-material/FileDownload";
import CalendarTodayIcon from "@mui/icons-material/CalendarToday";
import KeyboardArrowDownIcon from "@mui/icons-material/KeyboardArrowDown";

const EnquireHotelDashboard = () => {
  ...
  const fetchEnquiries = async () => {
    try {
      ...
      if (dateRange2.from && dateRange2.to) {
        url += `&fromDate=${dateRange2.from}&toDate=${dateRange2.to}`;
      }
      ...
      setError("Error fetching hotel enquiries. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleEditClick = (enquiry) => {
    ...
    setFormData({
      ...
      email: enquiry.email,
      phone: enquiry.phone,
      hotelId: enquiry.hotelId,
      hotelName: enquiry.hotelName,
      checkInDate: formatDateForInput(enquiry.checkInDate),
      checkOutDate: formatDateForInput(enquiry.checkOutDate),
  ...
  const handleExportCSV = () => {
    ...
    filteredEnquiries.forEach((enquiry) => {
      const row = [
        ...
        enquiry.email,
        enquiry.phone,
        enquiry.hotelName || enquiry.hotelId,
        formatDateForDisplay(enquiry.checkInDate),
        formatDateForDisplay(enquiry.checkOutDate),
        enquiry.guests,
        enquiry.rooms,
        enquiry.status,
      ];
    ...
    link.setAttribute(
      "download",
      `hotel-enquiries-${new Date().toISOString().split("T")[0]}.csv`
    );
    ...
    >
      <div className="page-header">
        <div className="header-content">
          <h1 className="page-title">Hotel Enquiries</h1>
          <p className="page-subtitle">
            Manage and track all hotel booking requests
          </p>
        </div>
      ...
      <Card className="table-card">
        {/* <Card.Header>
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            <h5 className="mb-0">Hotel Enquiries</h5>
              ...
              <div className="date-range-picker">
                <InputGroup>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setDateRange2({ ...dateRange2, from: e.target.value })
                    }
                  />
                </InputGroup>
                <InputGroup>
                  ...
                  <Form.Control
                    ...
                    value={dateRange2.to}
                    onChange={(e) =>
                      setDateRange2({ ...dateRange2, to: e.target.value })
                    }
                  />
                </InputGroup>
                <Button
        ...
        <div className="modern-card-header">
          <h2 className="modern-header-title">Hotel Enquiries</h2>
                  ...
                  {getPaginatedData().length > 0 ? (
                    getPaginatedData().map((enquiry) => (
                      <tr key={enquiry.id}>
                        ...
                        <td>{enquiry.email}</td>
                        <td>{enquiry.phone}</td>
                        <td>{enquiry.hotelName || enquiry.hotelId}</td>
                        <td>{formatDateForDisplay(enquiry.checkInDate)}</td>
                        <td>{formatDateForDisplay(enquiry.checkOutDate)}</td>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Edit Hotel Enquiry</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Row>
...
export default EnquireHotelDashboard;
